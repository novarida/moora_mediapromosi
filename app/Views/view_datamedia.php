                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tabel Data Media Promosi</h3>
                                </div>
                                <!-- /.card-header -->

                                <div class="card-body">
                                    <p>
                                        <a href="<?php echo site_url('Home/tambahmedia'); ?>" class="btn btn-purple">Tambah Data Media</a>
                                    </p>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="<?= site_url('Home/formeditmedia/' . $row->id_media) ?>" class="btn btn-primary">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>

                                                    <form action="<?= site_url('Home/deletemedia/' . $row->id_media) ?>" method="post"
                                                        style="display:inline;">
                                                        <?= csrf_field() ?>
                                                        <input type="hidden" name="_method" value="DELETE" />
                                                        <button type="submit" class="btn btn-link text-danger"
                                                            onclick="return confirm('Apakah Anda yakin ingin menghapus media ini?')"><i class="fas fa-trash-alt fa-lg"></i></button>
                                                    </form>
                                                    </td>
