                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Form to edit media -->
                                    <form method="post" action="<?= base_url('Home/editmedia/' . $media->id_media) ?>">
                                        <div class="form-group">
                                            <label for="id_media">ID Media</label>
                                            <input type="text" class="form-control" name="id_media" value="<?= set_value('id_media', $media->id_media) ?>" readonly>
                                        </div>

                                        <div class="form-group">
                                            <label for="nama_media">Nama media</label>
                                            <input type="text" class="form-control" name="nama_media" value="<?= set_value('nama_media', $media->nama_media) ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="jumlah">Jumlah</label>
                                            <input type="text" class="form-control" name="jumlah" value="<?= set_value('jumlah', $media->jumlah) ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="pj_media">Penanggung Jawab</label>
                                            <input type="text" class="form-control" name="pj_media" value="<?= set_value('pj_media', $media->pj_media) ?>">
                                        </div>
