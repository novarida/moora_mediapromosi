                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p>
                                        <a href="<?php echo site_url('Home/tambahkriteria'); ?>" class="btn btn-purple">Tambah Data Kriteria</a>
                                    </p>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="<?= site_url('Home/formeditkriteria/' . $row->id_kriteria) ?>" class="btn btn-primary">
                                                    ...
                                                    <form action="<?= site_url('Home/deletekriteria/' . $row->id_kriteria) ?>" method="post"
                                                        ...
                                                        <button type="submit" class="btn btn-link text-danger"
                                                            onclick="return confirm('Apakah Anda yakin ingin menghapus kriteria ini?')"><i class="fas fa-trash-alt fa-lg"></i></button>
                                                    </form>
                                                    </td>
